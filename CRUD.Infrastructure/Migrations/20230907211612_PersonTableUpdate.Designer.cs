...
namespace CRUD.Infrastructure.Migrations
{
    ...
    [Migration("20230907211612_PersonTableUpdate")]
            ...
            modelBuilder.Entity("CRUD.Core.Domain.Entities.Airplane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AirplaneId = new Guid("9d621276-b4fd-41ad-a995-6a8f9a60cb2a"),
                            Manufacturer = "Boeing",
                            Price = 15000000.0,
                            Production = new DateTime(2023, 9, 7, 23, 16, 11, 662, DateTimeKind.Local).AddTicks(3912),
                            Type = "737-700"
                        });
                });
            ...
            modelBuilder.Entity("CRUD.Core.Domain.Entities.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CityId = new Guid("6cf29c0a-eef3-4160-ae95-4d11bf514fd3"),
                            Name = "Budapest",
                            Population = 300000,
                            PostalCode = "1058"
                        });
